...
(()=>{
    const e = new Error("Cannot find module 'genkit/logging'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module 'genkit/model'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module 'genkit/plugin'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
function googleAIPlugin(options) {
    ...
    return genkitPlugin("googleai", async (ai)=>await initializer(ai, options), async (ai, actionType, actionName)=>await resolver(ai, actionType, actionName, options), async ()=>{
...
//# sourceMappingURL=node_modules_%40genkit-ai_b1a26eb7._.js.map