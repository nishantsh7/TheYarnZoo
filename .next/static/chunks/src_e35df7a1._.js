...
"[project]/src/actions/data:689182 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-toast.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$689182__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/actions/data:689182 [app-client] (ecmascript) <text/javascript>");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const IntentSearchBar = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$689182__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["intentBasedSearchAction"])({
                query
            });
...
_s(IntentSearchBar, "bZFWAygmk4TLDofpP2gCJVJmaeI=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "IntentSearchBar");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
const CartProvider = ({ children })=>{
    ...
    }["CartProvider.useEffect"], []); // Empty dependency array: runs once on mount (client-side)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartProvider.useEffect": ()=>{
            ...
            setCartItems({
                "CartProvider.useCallback[addToCart]": (prevItems)=>{
                    const existingItem = prevItems.find({
                        "CartProvider.useCallback[addToCart].existingItem": (i)=>i.productId === item.productId
                    }["CartProvider.useCallback[addToCart].existingItem"]);
                    if (existingItem) {
                        return prevItems.map({
                            "CartProvider.useCallback[addToCart]": (i)=>i.productId === item.productId ? {
                                    ...i,
        ...
        "CartProvider.useCallback[removeFromCart]": (productId)=>{
            setCartItems({
                "CartProvider.useCallback[removeFromCart]": (prevItems)=>prevItems.filter({
                        "CartProvider.useCallback[removeFromCart]": (item)=>item.productId !== productId
        ...
        "CartProvider.useCallback[updateQuantity]": (productId, quantity)=>{
            setCartItems({
                "CartProvider.useCallback[updateQuantity]": (prevItems)=>prevItems.map({
                        "CartProvider.useCallback[updateQuantity]": (item)=>item.productId === productId ? {
                                ...item,
    ...
    const getCartTotal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[getCartTotal]": ()=>{
            return cartItems.reduce({
                "CartProvider.useCallback[getCartTotal]": (total, item)=>total + item.price * item.quantity
    ...
    const getItemCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[getItemCount]": ()=>{
            return cartItems.reduce({
                "CartProvider.useCallback[getItemCount]": (count, item)=>count + item.quantity
            }["CartProvider.useCallback[getItemCount]"], 0);
        }
    }["CartProvider.useCallback[getItemCount]"], [
        cartItems
    ]);
...
_s(CartProvider, "ZqXXPx5NCA452KDXv91bY2TZl4s=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$IntentSearchBar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/shared/IntentSearchBar.tsx [app-client] (ecmascript)");
...
const Header = ()=>{
    ...
    const [isCategoryDrawerOpen, setIsCategoryDrawerOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const { getItemCount, cartItems } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: status === 'authenticated' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$IntentSearchBar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                            fileName: "[project]/src/components/layout/Header.tsx",
                            lineNumber: 117,
                            columnNumber: 15
                        }, this)
                                        ...
                                        children: [
                                            ...
                                            status === 'authenticated' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                children: [
                                                    ...
                                                    session.user?.name && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(Header, "eDJ9hffNMe310B9caEKiCFDm0RE=", false, function() {
    return [
...
"[project]/src/providers/NextAuthProvider.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_e35df7a1._.js.map